...
[[ -z $CHAIN_ID ]] && CHAIN_ID="haqq_11235-1"
[[ -z $CONFIG_PATH ]] && CONFIG_PATH="/root/.haqqd"
[[ -z $PUBLIC_RPC ]] && PUBLIC_RPC="https://rpc.tm.haqq.network:443"
...
init_node() {
  ...
  wget -O $CONFIG_PATH/config/genesis.json ${GENESIS_URL:-https://raw.githubusercontent.com/haqq-network/mainnet/master/genesis.json}
