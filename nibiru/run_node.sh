...
[[ -z $CHAIN_ID ]] && CHAIN_ID="cataclysm-1"
[[ -z $CONFIG_PATH ]] && CONFIG_PATH="/root/.nibid"
[[ -z $PUBLIC_RPC ]] && PUBLIC_RPC="https://rpc.nibiru.fi:443"
...
init_node() {
  ...
  sed -i \
    ...
    -e 's|^minimum-gas-prices =.*|minimum-gas-prices = "0.0025unibi"|' \
